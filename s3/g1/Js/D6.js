...
*/
function pari(array){
  return array.filter(elementi => elementi % 2 === 0)
}
console.log(pari([21,22,60,2,5,6,7,10,9]));
/* ESERCIZIO 4 (forEach)
  Scrivi una funzione per sommare i numeri contenuti in un array
*/
         
function addizione(valori){
  let numeri = 0;
  valori.forEach(dati=> numeri += dati);
  return numeri;
}
console.log(addizione([3,3,4,6,]))
